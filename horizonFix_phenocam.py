...
import pandas as pd
from horizonFix import writetocsv
...
if __name__ == '__main__':
    ...
    rotation_save_dir = Path(r"/mnt/databackup/ITEX-AON_Phenocam_Images/Phenocam_2016-2022/Atqasuk/Phenocam_ATQ_Leveled/")
    ...
    data_dir = Path(r"/mnt/databackup/ITEX-AON_Phenocam_Images/Phenocam_2016-2022/Atqasuk/phenocam_ATQ_time_corrected/")
    ...
    for imdir in tqdm(input_img_paths):
        ...
        try:
            ...
            csvName = buildName([tag,"level", serial, imgType, year,"stats"],".csv")
